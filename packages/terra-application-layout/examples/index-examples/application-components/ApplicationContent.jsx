...
class ApplicationContent extends React.Component {
  ...
  render() {
    const { layoutConfig, app, basePath, contentName, noMenu } = this.props;
    ...
    return (
      ...
      >
        <div style={{ padding: '1.5rem' }}>
          ...
          <hr />
          <p>Content and menu components will receive a prop named `layoutConfig` which contains APIs for manipulating the ApplicationLayout's state. When the layout is tiny or small, the layoutConfig will include a function called `toggleMenu` which will present or dismiss the menu, if present.</p>
...
// const ApplicationContent = ({ layoutConfig, app, basePath, contentName, includeRoutingSection, includeEventsSection }) => (
// );
